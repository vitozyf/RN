    ...
    for (const key in UserIdentity) {
      ...
      UserIdentityEle.push((
        <View style = {styles.rowView} key={key}>
          <Text style = {[styles.textCommon, styles.textTitle, styles[titleClass]]}>{key}</Text>
          <Text 
            style = {[styles.textCommon, UserIdentity[key] ? styles.textTrue : styles.textFalse]}>
            {
              UserIdentity[key] && <AntDesign name="checkcircleo" size={16}></AntDesign>
            }
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.helpBox}>
          <Text style={styles.helpText} onPress={this.toHelpPage}>我要帮助</Text>
        </View>
      </View>
    )
  }
